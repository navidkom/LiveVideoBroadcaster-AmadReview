...
public class LiveVideoBroadcasterFragment extends Fragment implements View.OnClickListener {
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className,
            ...
            if (mLiveVideoBroadcaster == null) {
                ...
                mLiveVideoBroadcaster.init(getActivity(), mGLView);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_live_video_broadcaster, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mStreamNameEditText = (EditText) view.findViewById(R.id.stream_name_edit_text);

        mRootView = (ViewGroup) view.findViewById(R.id.root_layout);
        mSettingsButton = (ImageButton) view.findViewById(R.id.settings_button);
        mSettingsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showSetResolutionDialog(v);
            }
        });

        view.findViewById(R.id.changeCameraButton).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                changeCamera(v);
            }
        ...
        mStreamLiveStatus = (TextView) view.findViewById(R.id.stream_live_status);

        mBroadcastControlButton = (Button) view.findViewById(R.id.toggle_broadcasting);
        mBroadcastControlButton.setOnClickListener(this);

        // Configure the GLSurfaceView.  This will start the Renderer thread, with an
        // appropriate EGL activity.
        mGLView = (GLSurfaceView) view.findViewById(R.id.cameraPreview_surfaceView);
        if (mGLView != null) {
...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        mLiveVideoBroadcasterServiceIntent = new Intent(getContext(), LiveVideoBroadcaster.class);
        //this makes service do its job until done
        getContext().startService(mLiveVideoBroadcasterServiceIntent);
    ...
    public void onStart() {
        ...
        getContext().bindService(mLiveVideoBroadcasterServiceIntent, mConnection, 0);
    ...
    public void showSetResolutionDialog(View v) {
        ...
        Fragment fragmentDialog = getChildFragmentManager().findFragmentByTag("dialog");
        ...
        if (!mIsRecording)
        {
            if (mLiveVideoBroadcaster != null) {
                if (!mLiveVideoBroadcaster.isConnected()) {
                    String streamName = MainActivity.RTMP_BASE_URL + mStreamNameEditText.getText().toString();
