...
public class LiveVideoPlayerFragment extends Fragment implements View.OnClickListener, PlaybackControlView.VisibilityListener, ExoPlayer.EventListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_live_video_player, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        videoStartControlLayout =  view.findViewById(R.id.video_start_control_layout);

        simpleExoPlayerView = (SimpleExoPlayerView)  view.findViewById(R.id.player_view);
        simpleExoPlayerView.setControllerVisibilityListener(this);
        simpleExoPlayerView.requestFocus();

        view.findViewById(R.id.play_live_video).setOnClickListener(this);
    }
...
//    }
    ...
    public void onClick(View view) {
        ...
        if(view.getId() == R.id.play_live_video){
            play(view);
        }
    }
...
//                    null, extensionRendererMode);
               ...
               player = ExoPlayerFactory.newSimpleInstance(getContext(), trackSelector,
                       new DefaultLoadControl(new DefaultAllocator(true, C.DEFAULT_BUFFER_SEGMENT_SIZE),  500, 1000, 500, 1000),
                       null, extensionRendererMode);
    ...
    public void play(View view) {
        String URL = MainActivity.RTMP_BASE_URL + videoNameEditText.getText().toString() + MainActivity.RTMP_URL_POSTFIX;
